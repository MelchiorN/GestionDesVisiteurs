...
@section('title', 'Modifier Resident')

@section('content')
<div class="max-w-4xl mx-auto bg-white rounded-xl shadow-md p-6 mt-10">
    <h1 class="text-2xl font-bold text-indigo-700 mb-6">Modifier le resident</h1>
    ...
    <form method="POST" action="{{ route('resident.update', $locataire->id) }}">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
             ...
             <div>
                ...
                @if($locataire->photo)
                    <img src="{{ asset('storage/' . $locataire->photo) }}" alt="Photo" class="h-16 mt-2 rounded">
                @endif
            </div>
        </div>

        <div class="mt-8 flex justify-end">
            <a href="#" class="bg-gray-500 text-white px-4 py-2 rounded-md mr-2 hover:bg-gray-600">
                Annuler
            </a>
